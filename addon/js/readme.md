...
| No Potions Render       | Disable the effects hud.                                                          |
...
| Anti Off Hand           | Disable swapping items in certain conditions.                                     |
| Ghost Interactions      | Disable sending container opening packets.                                        |
